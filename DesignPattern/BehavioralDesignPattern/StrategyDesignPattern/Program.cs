...
//Adding the different shipping strategies
...
builder.Services.AddTransient<IShippingStrategy, OvernightShippingStrategy>();
builder.Services.AddTransient<ShippingStrategyFactory>();

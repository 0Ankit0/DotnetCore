...
public static class IdentityApiEndpoints
{
    ...
    public static IEndpointConventionBuilder MapIdentityApiEndpoint<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapIdentityApiEndpoint)} requires a user store with email support.");
            }
            ...
            ([FromBody] LoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp) =>
        {
            ...
            catch (Exception ex)
            {
                ...
                return TypedResults.Problem($"Exception: {ex.Message}\n{ex.StackTrace}", statusCode: 500);
            }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapIdentityApiEndpoint)}-{finalPattern}";
